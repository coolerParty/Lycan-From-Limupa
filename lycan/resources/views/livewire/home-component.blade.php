                            ...
                            <div class="slider-area pt-sm-30 pt-xs-30">
                                <div class="slider-active owl-carousel">
                                    @foreach($homeSliders as $homeSlider)
                                        ...
                                        <div class="
                                            @if($homeSlider->position == 1)
                                                single-slide d-flex justify-content-end align-items-center pull-right animation-style-02 bg-4
                                            @elseif($homeSlider->position == 2)
                                                single-slide d-flex justify-content-center align-items-center animation-style-02 bg-4
                                            @else   
                                                single-slide align-center-left animation-style-02 bg-4
                                            @endif                                        
                                        " style="
                                            @if($homeSlider->position == 1)
                                            ...
                                            @endif
                                         background-image: url({{asset('images/slider')}}/{{ $homeSlider->image }});">
                                            <div class="slider-progress"></div>
                                            <div class="slider-content">
                                                <h5>{{ $homeSlider->hTitleLeft }} <span>{{ $homeSlider->hTitleCenter }}</span> {{ $homeSlider->hTitleRight }}</h5>
                                                <h2>{{ $homeSlider->title }}</h2>
                                                <h3>{{ $homeSlider->subtitleLeft }} <span>{{ $homeSlider->subtitleCenter }}</span> {{ $homeSlider->subtitleRight }}</h3>
                            ...
                            <div class="li-banner-2 pt-15">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="single-banner">
                                            <a href="#">
                                                <img src="{{ asset('images/banner/2_1.jpg') }}" alt="Li's Static Banner">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- Single Banner Area End Here -->
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="single-banner pt-xs-30">
                                            <a href="#">
                                                <img src="{{ asset('images/banner/2_2.jpg') }}" alt="Li's Static Banner">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- Single Banner Area End Here -->
                            ...
                            <div class="li-banner-2 pt-15">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="single-banner">
                                            <a href="#">
                                                <img src="{{ asset('images/banner/2_5.jpg') }}" alt="Li's Static Banner">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- Single Banner Area End Here -->
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="single-banner pt-xs-30">
                                            <a href="#">
                                                <img src="{{ asset('images/banner/2_6.jpg') }}" alt="Li's Static Banner">
                                            </a>
                                        </div>
                                    </div>
                                    <!-- Single Banner Area End Here -->
