            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="{{ asset('images/product/large-size') }}/{{$product->image}}" data-gall="myGallery">
                                <img src="{{ asset('images/product/large-size') }}/{{$product->image}}" alt="product image">
                            </a>
                        </div>                        
                    </div>
                    ...
                    <div class="product-info">
                        ...
                        <div class="single-add-to-cart">
                            <form class="cart-quantity" action="">
                                ...
                                <button class="add-to-cart" type="submit" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->regular_price}},)">Add to cart</button>
