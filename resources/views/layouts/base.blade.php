                                ...
                                <div class="header-top-right">
                                    <ul class="ht-menu">                                        
                                        ...
                                        <li>
                                            @if(Route::has('login'))
                                                @auth
                                                    <div class="ht-setting-trigger"><span>My Account ({{ Auth::user()->name }})</span></div>
                                                    <div class="setting ht-setting">
                                                        <ul class="ht-setting-list">                                                            
                                                            @if(Auth::user()->utype === 'ADM')                                                                
                                                                <li><a title="Dashboard" href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                                                <li><a title="Category" href="{{ route('admin.categories') }}">Category</a></li>
                                                                <li><a title="Product" href="{{ route('admin.products') }}">Product</a></li>
                                                                <li><a title="Product" href="{{ route('admin.homeslider') }}">Home Slider</a></li>
                                                            @else
                                        ...
                                        <li class="hm-minicart">
                                            ...
                                            <div class="minicart">
                                                <ul class="minicart-product-list">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('product.details',['slug'=>$item->model->slug]) }}" class="minicart-product-image">
                                                            <img src="{{ asset('images/product/small-size/') }}/{{$item->model->image}}" alt="{{$item->model->name}}">
                                                        </a>
